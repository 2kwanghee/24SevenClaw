...
[하네스 루프 진입]
    ...
    │
    ├──→ 4-A. 전부 통과? → 최종 리뷰
    │         - CODE_REVIEW 역할로 코드 품질 검토 (작성자와 별도 컨텍스트의 리뷰어로 분리)
    │         - 에이전트 플랫폼 내장 역할 분리로 순차 수행 — 작성자 편향 보완
    │         - 리뷰 통과 → ✅ 완료
...
- api: `cd /mnt/c/workspace/24SevenClaw/clickeye-api && ...`
- web: `cd /mnt/c/workspace/24SevenClaw/clickeye-web && ...`
- agent: `cd /mnt/c/workspace/24SevenClaw/clickeye-agent && ...`
- contracts: `cd /mnt/c/workspace/24SevenClaw/clickeye-contracts && ...`
