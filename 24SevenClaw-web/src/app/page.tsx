    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-white/5 bg-slate-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <a href="#platforms" className="text-sm text-slate-400 transition-colors hover:text-white">
              지원 플랫폼
            </a>
          </div>
      ...
      <section className="relative overflow-hidden pt-32 pb-20">
        ...
        <div className="absolute inset-0">
          <div className="absolute left-1/2 top-0 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-violet-500/15 blur-[120px]" />
          <div className="absolute left-1/4 top-40 h-[400px] w-[400px] rounded-full bg-indigo-500/10 blur-[100px]" />
          <div className="absolute right-1/4 top-60 h-[300px] w-[300px] rounded-full bg-cyan-500/10 blur-[80px]" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/10 px-4 py-1.5">
            ...
            <span className="text-xs font-medium text-violet-300">Web-First AI 솔루션 빌더</span>
          </div>
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href="#how-it-works"
              className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-8 py-3.5 text-sm font-medium text-slate-300 transition-all hover:bg-white/10 hover:text-white"
            >
          ...
          {/* 위저드 프리뷰 */}
          <div className="mx-auto mt-20 max-w-3xl overflow-hidden rounded-2xl border border-white/10 bg-slate-900/80 shadow-2xl shadow-black/50">
            {/* 스텝 바 */}
            <div className="flex items-center gap-1 border-b border-white/5 px-4 py-3 overflow-x-auto">
                  ...
                  >
                    <div
                      className={`flex h-4 w-4 shrink-0 items-center justify-center rounded ${
                        agent.selected ? "bg-violet-500" : "border border-white/10"
                      }`}
                    >
                      {agent.selected && <Check className="h-2.5 w-2.5 text-white" />}
                    </div>
                    {agent.name}
                    {agent.required && (
                      <span className="ml-auto rounded bg-slate-700 px-1 py-0.5 text-[9px] text-slate-400">
                        필수
                      </span>
                    )}
                  </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-2">
            {features.map((f) => (
              ...
              >
                <div
                  className={`inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${f.gradient} shadow-lg`}
                >
      ...
      <section id="how-it-works" className="relative py-24">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold md:text-4xl">어떻게 작동하나요?</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-400">
              3단계로 AI 개발 환경을 완성하세요
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {howItWorks.map((item) => (
              <div key={item.step} className="relative rounded-2xl border border-white/5 bg-white/[0.02] p-8">
                ...
                <div className="mt-4 flex h-10 w-10 items-center justify-center rounded-xl bg-violet-500/10">
          ...
          {/* 미니 터미널 프리뷰 */}
          <div className="mx-auto mt-12 max-w-2xl overflow-hidden rounded-xl border border-white/10 bg-slate-900/80">
            <div className="flex items-center gap-2 border-b border-white/5 px-4 py-2.5">
              <div className="h-2.5 w-2.5 rounded-full bg-red-500/60" />
              <div className="h-2.5 w-2.5 rounded-full bg-yellow-500/60" />
              <div className="h-2.5 w-2.5 rounded-full bg-green-500/60" />
              <span className="ml-3 text-[10px] text-slate-500">Terminal</span>
            </div>
            <div className="p-5 font-mono text-sm leading-relaxed">
              <p className="text-slate-500">$ unzip my-saas.zip && cd my-saas</p>
              <p className="mt-1 text-slate-500">$ claude</p>
              <p className="mt-2 text-emerald-400">{">"} CLAUDE.md를 읽고 있습니다...</p>
              <p className="text-slate-500">{">"} 하네스 엔지니어링 4단계 파이프라인 활성화</p>
                ...
                <div className="mt-4 space-y-1.5">
                  {p.files.map((file) => (
                    <div key={file} className="flex items-center gap-2">
                      ...
                      <code className="text-xs text-slate-400">{file}</code>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="pricing" className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mx-auto max-w-lg text-center">
            <h2 className="text-3xl font-bold md:text-4xl">지금은 무료입니다</h2>
            ...
            <div className="mt-10 rounded-2xl border border-violet-500/20 bg-violet-500/5 p-8 text-left shadow-xl shadow-violet-500/5">
              <div className="mb-6 flex items-baseline gap-2">
                <span className="text-3xl font-bold">Early Access</span>
              ...
              <Link
                href="/register"
                className="mt-8 block w-full rounded-xl bg-violet-600 py-3 text-center text-sm font-semibold text-white shadow-lg shadow-violet-600/25 transition-all hover:bg-violet-500"
              >
                무료로 시작하기
              </Link>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-950 via-indigo-950 to-slate-950 p-12 text-center md:p-20">
            <div className="absolute inset-0 opacity-30">
              <div className="absolute -left-20 -top-20 h-80 w-80 rounded-full bg-violet-500 blur-[120px]" />
