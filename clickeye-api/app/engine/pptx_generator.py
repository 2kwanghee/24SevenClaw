...
def _numbered_items(
    ...
    for label, cmd in items:
        _add_text(slide, label, Inches(0.8), Inches(y), body_w, Inches(0.55), size=14, color=_WHITE)
        y += 0.55
        if cmd:
            _add_text(
                slide,
...
def build_setup_guide_pptx(
    ...
    _add_text(
        s,
        "💡  Windows 사용자: WSL2 Ubuntu 터미널에서 실행하세요 (탐색기 더블클릭 X)",
        Inches(0.8),
        Inches(5.8),
        body_w,
        Inches(0.6),
    ...
    _add_text(
        s,
        ".env.example → .env 로 복사 후 아래 키를 입력하세요",
        Inches(0.8),
        Inches(1.35),
        body_w,
        Inches(0.55),
    ...
    _add_text(
        s,
        "📁  docs/api-keys/ 폴더에서 각 키 발급 방법을 확인하세요.",
        Inches(0.8),
        Inches(y + 0.2),
        body_w,
        Inches(0.6),
    ...
    if has_linear:
        ...
        _add_text(
            s,
            "start.sh 하나로 터널·Webhook·Watcher가 자동 기동됩니다.",
            Inches(0.8),
            Inches(1.35),
            body_w,
            Inches(0.55),
        ...
        _add_text(
            s,
            "💡  start.sh 완료 후 터미널을 닫아도 파이프라인은 계속 실행됩니다.",
            Inches(0.8),
            Inches(5.8),
            body_w,
            Inches(0.6),
        ...
        _add_text(
            s,
            "WSL2 재시작 후에도 서비스가 자동 복구되도록 systemd에 등록합니다.",
            Inches(0.8),
            Inches(1.35),
            body_w,
            Inches(0.55),
        ...
        _add_text(
            s,
            "셋업 완료 후 AI Team 메뉴에서 작업 요청을 등록하세요.",
            Inches(0.8),
            Inches(1.35),
            body_w,
            Inches(0.55),
        ...
        _numbered_items(
            s,
            [
                ("① 터미널에서 런처 스크립트 실행", "bash start.sh"),
