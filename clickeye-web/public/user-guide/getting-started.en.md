...
description: A basic guide for those using the ClickEye platform for the first time.
order: 1
---
...
- **Web Dashboard**: Solution design and project management
- **Agent Platform**: Supports Claude Code, Gemini CLI, Cursor, and Codex
- **CLI Tool**: A command-line interface for power users
